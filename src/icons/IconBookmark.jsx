...
const IconBookmark = ({ className, fill = false, duotone = true, bookmark = true }) => {
    return (
        <>
            {!fill ? (
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
                    <path
                        ...
                        strokeWidth="1.5"
                    />
                    {bookmark && <path opacity={duotone ? '0.5' : '1'} d="M15 6H9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />}
                </svg>
            ) : (
